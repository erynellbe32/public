...
interface IRouter extends RequestHandler {
    ...
    // Alternatively, you can pass only a callback, in which case you have the opportunity to alter the server.param() API
...
interface Application extends IRouter, Express.Application {
    ...
    /**
        ...
        * mounted as "/fireAdmin", which itself
        * was mounted as "/blog" then the
        * return value would be "/blog/fireAdmin".
        */
    path(): string;
