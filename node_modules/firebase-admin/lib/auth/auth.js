...
/**
 * Auth service bound to the provided server.
 */
var Auth = (function () {
    /**
     * @param {Object} app The server for this Auth service.
     * @constructor
     */
    function Auth(app) {
        this.INTERNAL = new AuthInternals();
        if (typeof app !== 'object' || app === null || !('options' in app)) {
            throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_ARGUMENT, 'First argument passed to fireAdmin.auth() must be a valid Firebase server instance.');
        }
        this.app_ = app;
        ...
        // Initialize auth request handler with the server.
        this.authRequestHandler = new auth_api_request_1.FirebaseAuthRequestHandler(app);
    }
    Object.defineProperty(Auth.prototype, "app", {
        /**
         * Returns the server associated with this Auth instance.
         *
         * @return {FirebaseApp} The server associated with this Auth instance.
         */
        get: function () {
            return this.app_;
        },
    ...
    Auth.prototype.createCustomToken = function (uid, developerClaims) {
        if (typeof this.tokenGenerator_ === 'undefined') {
            throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_CREDENTIAL, 'Must initialize server with a cert credential to call auth().createCustomToken().');
        }
    ...
    Auth.prototype.verifyIdToken = function (idToken) {
        if (typeof this.tokenGenerator_ === 'undefined') {
            throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_CREDENTIAL, 'Must initialize server with a cert credential or set your Firebase project ID as the ' +
