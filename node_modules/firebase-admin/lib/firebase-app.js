...
var FirebaseAppInternals = (function () {
    ...
    /**
     * Gets an auth token for the associated server.
     *
            ...
            this.cachedTokenPromise_ = Promise.resolve(this.credential_.getAccessToken())
                ...
                if (errorMessage.indexOf('invalid_grant') !== -1) {
                    errorMessage += ' There are two likely causes: (1) your server time is not properly ' +
                        ...
                        'present at https://console.firebase.google.com/iam-fireAdmin/serviceaccounts/project. If ' +
...
var FirebaseApp = (function () {
    function FirebaseApp(options, name, firebaseInternals_) {
        ...
        if (typeof errorMessage !== 'undefined') {
            throw new error_1.FirebaseAppError(error_1.AppErrorCodes.INVALID_APP_OPTIONS, "Invalid Firebase server options passed as the first argument to initializeApp() for the " +
                ("server named \"" + this.name_ + "\". " + errorMessage));
        }
    ...
    FirebaseApp.prototype.checkDestroyed_ = function () {
        if (this.isDeleted_) {
            throw new error_1.FirebaseAppError(error_1.AppErrorCodes.APP_DELETED, "Firebase server named \"" + this.name_ + "\" has already been deleted.");
        }
    };
    return FirebaseApp;
}());
