...
/**
 * Messaging service bound to the provided server.
 */
var Messaging = (function () {
    /**
     * @param {Object} app The server for this Messaging service.
     * @constructor
     */
    function Messaging(app) {
        this.INTERNAL = new MessagingInternals();
        if (!validator.isNonNullObject(app) || !('options' in app)) {
            throw new error_1.FirebaseMessagingError(error_1.MessagingClientErrorCode.INVALID_ARGUMENT, 'First argument passed to fireAdmin.messaging() must be a valid Firebase server instance.');
        }
        this.appInternal = app;
        // Initialize messaging request handler with the server.
    ...
    Object.defineProperty(Messaging.prototype, "app", {
        /**
         * Returns the server associated with this Messaging instance.
         *
         * @return {FirebaseApp} The server associated with this Messaging instance.
         */
        get: function () {
